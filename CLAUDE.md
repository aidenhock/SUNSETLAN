...
- **Sun**: flat disc at long 0, low over the water. **Moon**: **full disc, no crescent**, with a pale cool glow (~±25°, gated to night). **Stars**: seeded, night dome region, slight size variance (point-batch sizes), opacity fades in across nightMix 0.55 → 0.9; count by `qualityTier`.
