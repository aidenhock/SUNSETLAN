...
- **Glitter visibility**: the lane's distance fade extends past the horizon water so it connects the viewer to a half-set disc; wider lane, larger/softer glints (low specular power), still a broken shimmer.
