...
const NUM_DIALS: Array<[string, keyof CharacterConfig, number, number, number, number]> = [
  ...
  ['Elbow idle (deg)', 'elbowRestBend', 0, 40, 1, 8],
  ['Elbow walk (deg)', 'elbowBendWalk', 0, 60, 1, 25],
  ['Elbow run (deg)', 'elbowBendRun', 0, 110, 1, 70],
  ['Elbow swing', 'elbowSwing', 0, 1, 0.05, 0.35],
  ...
  ['Hip frac', 'hipFrac', 0.3, 0.5, 0.005, 0.365],
  ['Waist slim', 'waistSlim', 0, 0.6, 0.02, 0.28],
  ['Torso depth', 'torsoDepth', 0.6, 1, 0.01, 0.78],
